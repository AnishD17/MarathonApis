...
builder.Services.AddDbContext<MarathonAuthDbContext>(options =>
options.UseSqlServer(builder.Configuration.GetConnectionString("AuthConnectionString")));

builder.Services.AddScoped<IRunnerRepository,SQLRunnerRepository>();
...
builder.Services.AddIdentityCore<IdentityUser>()
	...
	.AddTokenProvider<DataProtectorTokenProvider<IdentityUser>>("MarathonProvider")
	.AddEntityFrameworkStores<MarathonAuthDbContext>()
